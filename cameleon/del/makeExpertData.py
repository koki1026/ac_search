...
class makeExpertData(Node):
    def __init__(self):
        ...
        self.next_observation_start = False
    ...
    def timer_callback(self):
        ...
        if episode_status == 0:
            ...
            observation, next_observation_checker = self.makeObservationData(self.myVel, self.myAngleVel, self.myPose,self.myAngle,self.targetPose,self.nextTargetPose,self.windSpeed,self.windDirection,self.waveLevel,self.waveDirection)
            ...
            if next_observation_checker:
                self.next_observation_data.append(observation)
            print ("observation: ")
            print("episode status:", episode_status)
    ...
    def makeObservationData(self, myVel, myAngleVel, myPose,myAngle,targetPose,nextTargetPose,windSpeed,windDirection,waveLevel,waveDirection):
        ...
        next_observation_bool = self.next_observation_start
        self.next_observation_start = True
        ...
        '''
        return observation, next_observation_bool
    ...
    def final_append(self, action_index,myVel,myAngle,myAngleVel,myPose,prePose):
        for i in range(3):
            ...
            print ("action: ", self.action_data)
        next_observation, _ = self.makeObservationData(self.myVel, self.myAngleVel, self.myPose,self.myAngle,self.targetPose,self.nextTargetPose,self.windSpeed,self.windDirection,self.waveLevel,self.waveDirection)
        self.observation_data.append(next_observation)
        print ("observation: ")
